...
### 구조체 목록(Structures)
구조체 목록은 구조체의 필드 목록을 저장하는 세션입니다. ShitBF 0.2.0부터 사용할 수 있습니다. 최대 2,147,483,633개의 구조체를 저장할 수 있으나, 상수의 개수에 따라 최대 개수가 줄어듭니다. 각 구조체는 최대 4,294,967,296(2^32)개의 필드를 가질 수 있습니다.
